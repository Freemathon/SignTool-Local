...
echo "  1. ${GREEN}./SignTools${NC}  (Server mode)"
echo "  2. ${GREEN}./SignTools -headless -ipa <path> -profile <name> -output <path>${NC}  (CLI mode)"
echo "  3. ${GREEN}./build_app.sh${NC}  (Build .app bundle)"
echo ""
